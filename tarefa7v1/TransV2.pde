public class TransV2 {
    ...
    int [][]aplicarTransformacao(int [][]Pontos){
        ...
        for(int i = 0; i < Pontos.length; ++i){
            ...
            //faço os calculos das transformações e volto as coordenadas para o centro
            ...
            //aqui estou convertendo 3D para 2D, ou seja elimina eixo z  essa é a projeção ortográfica 
            resultado[i][2] = 0;
        }
        return resultado;
    }
